...
def unit(iv,i,o,d=3):
    ...
    if ib in dict_temp and ob in dict_temp:
        ...
        for unit_parents, unit_children in dict_conv.iteritems():
            if ib in unit_children and ob in unit_children:
                ...
                if output < 10**(-d):
                    ...
                    return np.round(output, 16)
                else:
                    return np.round(output, d)
...
"""
# Time conversion (#yr#mo#wk#dy#hr#min#s)
def time(yr=0.0,mo=0.0,wk=0.0,dy=0.0,hr=0.0,mn=0.0,s=0.0):
    try:
        key, value = inp.split('yr')
        value = float(inp.split('yr')[0])
    except ValueError:
        inp1 = 
    else:
        inp1 = inp.split('yr')
...
[a.split('yr')[0]] + [a.split('yr')[1].split('mo')[0]] + [a.split('yr')[1].split('mo')[1].split('wk')[0]] + [a.split('yr')[1].split('mo')[1].split('wk')[1].split('dy')[0]] + [a.split('yr')[1].split('mo')[1].split('wk')[1].split('dy')[1].split('hr')[0]] + [a.split('yr')[1].split('mo')[1].split('wk')[1].split('dy')[1].split('hr')[1].split('min')[0]] + [a.split('yr')[1].split('mo')[1].split('wk')[1].split('dy')[1].split('hr')[1].split('min')[1].split('s')[0]]
"""
